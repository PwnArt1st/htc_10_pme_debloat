...
choice /M "Did you install any keyboard besides TouchPal?"
if %ERRORLEVEL%==1 (
	echo Removing TouchPal keyboard
    adb shell "su -c 'rm -rf /system/priv-app/TouchPal*'"
    adb shell "su -c 'rm -rf /system/app/TouchPal*'"
    )
if %ERRORLEVEL%==2 (
	echo Leaving TouchPal keyboard intact
     )
